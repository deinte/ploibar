...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.ploibar.app'),
     ...
     */
    'author' => env('NATIVEPHP_APP_AUTHOR', 'Dante Schrauwen'),
     ...
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'macOS menu bar app for Ploi.io server monitoring'),
